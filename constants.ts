...
export const translations = {
  en: {
    ...
    signPuzzleInstructions: "Tap a circle to choose plus (+) or minus (−), or drag a sign into it.",
    ...
    signPuzzleAttempts: "You used {attempts} attempts on {tasks} tasks.",
    signPuzzleAttemptsPerfect: "You got every task right on the first try!",
    signPuzzleChooseSign: "Choose a sign",
    signPuzzleClearSign: "Clear",
    clear: "Clear",
    settings: "Settings",
    close: "Close",
  },
  no: {
    ...
    signPuzzleInstructions: "Trykk på en sirkel for å velge pluss (+) eller minus (−), eller dra et tegn inn.",
    ...
    signPuzzleAttempts: "Du brukte {attempts} forsøk på {tasks} regnestykker.",
    signPuzzleAttemptsPerfect: "Du fikk alle riktige på første forsøk!",
    signPuzzleChooseSign: "Velg tegn",
    signPuzzleClearSign: "Fjern",
    clear: "Tøm",
